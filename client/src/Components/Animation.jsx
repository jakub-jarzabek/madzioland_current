...
const Animation = (props) => {
  ...
  const handleTopRightOnClick = () => {
    document.querySelector('#AnimationDiv .NavigationLite').style.display =
      'flex'
    setTimeout(() => {
  ...
  return (
    <div className="Animation" id="AnimationDiv">
      ...
      <p className="Legal">
        Copyright &copy;{' '}
        <a
          href="https://www.linkedin.com/in/magdalena-pierzchala/"
          className="NameLink"
        >
        ...
        | Website created By{' '}
        <a
          href="https://www.linkedin.com/in/jakub-jarzabek/"
          className="NameLink"
        >
          Jakub Jarząbek
        </a>
      ...
      <div
        ...
        style={{
          transition: '1.5s',
          clipPath: clipPath.typo,
          zIndex: zIndex.typo,
        }}
        id="OuterTypo"
        onClick={handleTypoOnClick}
        onMouseEnter={handleTypoOnMouseOver}
      >
        ...
        <img
          ...
          id="TypoHeader"
          style={{ opacity: typoContentOpacity.header }}
        />
        <iframe
          src="https://www.youtube.com/embed/X0c4m5gfOfs?rel=0&modestbranding=1&autohide=1&showinfo=0&controls=0"
          title="YouTube video player"
          frameBorder="0"
          allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          className="TypoMovie"
          style={{
            opacity: typoContentOpacity.movie,
            display: typoMovieDisplay,
          }}
        />
      </div>

      <div
        className="OuterComics"
        style={{
          transition: '1.5s',
          clipPath: clipPath.comics,
          zIndex: zIndex.comics,
        }}
        id="OuterComics"
        onClick={handleComicsOnClick}
        onMouseEnter={handleComicsOnMouseOver}
      >
        ...
        <img
          src={comicsHeader}
          alt=""
          className="ComicsHeader"
          id="ComicsHeader"
          style={{ opacity: comicsContentOpacity.header }}
        />
        <iframe
          src="https://www.youtube.com/embed/F9GVPw0ueOY?rel=0&modestbranding=1&autohide=1&showinfo=0&controls=0"
          title="YouTube video player"
          frameBorder="0"
          allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
          className="ComicsMovie"
          style={{
            opacity: comicsContentOpacity.movie,
            display: comicsMovieDisplay,
          }}
        />
      </div>
      <div
        className="border"
        style={{ clipPath: clipPath.border }}
        id="Border"
      />
      <div
        className="TopRight"
        id="TopRight"
        onClick={handleTopRightOnClick}
        style={{ opacity: topRightOpacity, display: topRightDisplay }}
      >
        <span>{BackBtn}</span>
      </div>
      <div
        ...
        id="BottomLeft"
        onClick={handleBottomLeftOnClick}
        style={{ opacity: bottomLeftOpacity, display: bottomLeftDisplay }}
      >
        <span>{BackBtn}</span>
      </div>
    </div>
